...
diabetes_model = pickle.load(open('D:/Multiple Disease Prediction Platform/Saved Models/diabetes_model.sav','rb'))
heart_disease_model = pickle.load(open('D:/Multiple Disease Prediction Platform/Saved Models/heart_disease_model.sav','rb'))
parkinsons_model = pickle.load(open('D:/Multiple Disease Prediction Platform/Saved Models/parkinsons_model.sav','rb'))
breast_cancer_model = pickle.load(open('D:/Multiple Disease Prediction Platform/Saved Models/breast_cancer_model.sav','rb'))
